...
parser.add_argument('--data_dir', type=str, default='dataset/ter_mul/4')
parser.add_argument('--vocab_dir', type=str, default='dataset/ter_mul/4')
...
parser.add_argument('--id', type=str, default='termul4', help='Model ID under which to save models.')
